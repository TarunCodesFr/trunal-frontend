                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
                        ...
                        >
                            ...
                            <p className="text-white/50 text-lg leading-relaxed max-w-xl mb-8">
                                Ready to scale your digital presence? Schedule a
                                no-strings-attached consultation with our lead
                                engineers to discuss your vision, goals, and
                            ...
                            <div className="grid sm:grid-cols-2 gap-6">
                                <div className="p-4 rounded-xl border border-white/5 bg-white/2">
                                    ...
                                    <p className="text-white/30 text-sm">
                                        Find a slot that works for you in our
                                        live calendar.
                                    </p>
                                </div>
                                <div className="p-4 rounded-xl border border-white/5 bg-white/2">
                                    ...
                                    <p className="text-white/30 text-sm">
                                        Our Trunal team will call on your
                                ...
                                <div className="p-4 rounded-xl border border-white/5 bg-white/2">
                                    ...
                                    <p className="text-white/30 text-sm">
                                        We'll discuss your goals and how we can
                                ...
                                <div className="p-4 rounded-xl border border-white/5 bg-white/2">
                                    ...
                                    <p className="text-white/30 text-sm">
                                        After the consultation, we'll finalize
                                        the project details and begin
                                        development.
                                    </p>
                                </div>
                            </div>
